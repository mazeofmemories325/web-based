      ...
      <div class="row">
          <div class="col-md-6 offset-md-3">
              <div class="signup-form">
                  ...
                  <p class="text-center mt-3 text-secondary">Belum memiliki akun? <a href="daftar-akun-pelamar.php"> Daftar</a></p>
                  <p class="text-center mt-3 text-secondary">Masuk sebagai <a href="masuk-akun-admin.php"> Admin</a></p>
              </div>
          </div>
      </div>
  </div>
